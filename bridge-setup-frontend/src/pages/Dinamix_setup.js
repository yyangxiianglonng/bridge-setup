    ...
    return (
        <div className="site-card-border-less-wrapper">
            ...
            <Card title="TeamViewerをインストール" extra={<Checkbox />}>
                <span className='downloady'><a target='_blank' href='https://get.teamviewer.com/dinamix'>ダイナミクス様用TeamViewerをダウンロード</a></span>
                <Row justify='start'>
                    <Col sm={24} md={12} lg={6} xl={4}>
                        <CopyToClipboard text='Bridge2019!2' onCopy={() => { message.success('パスワードをクリップボードにコピーしました') }}>
                            <span className='clipy'>PW: [ Bridge2019!2 ]</span>
                        </CopyToClipboard>
                    </Col>
                </Row>
            </Card>
